...
<!--        <h1><a href="websiteHome.php"><font color="#68B3C8">DOLLJOY</font></a></h1>	-->
	...
	<div id="menu">
		<ul>
			...
			<li class="active"><a href="websiteFAQs.php" accesskey="4" title="">FAQS</a></li>
...
<div id="featured" class="container">
	...
	<div class="blog-thumb">
       ...
       <br>
        ...
        <h3><font color="#68B3C8"><b>Do I need to give a sample if I want to order a customized doll?</b></font></h3>
       ...
       <br>
        ...
        <h3><font color="#68B3C8"><b>Can I order a doll from your gallery, and still have it customized to my liking?</b></font></h3>

       <p>Yes, you may choose and order from our pre-existing dolls and still have the option to modify them further.</p>

       <br>

        <h3><font color="#68B3C8"><b>How can I pay for my order?</b></font></h3>
